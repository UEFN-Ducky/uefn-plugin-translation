...
Usage:
  ...
  py scripts/release.py --sync-seed  # also copy into frontend/uefn_plugins/translation
"""
...
def main() -> None:
    ...
    parser.add_argument("--sync-seed", action="store_true", help="Sync into frontend/uefn_plugins/translation")
